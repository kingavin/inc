...
class TwigView
{
    ...
    public function __construct($templatePath=null, $envOptions=array())
    {
        ...
        $this->_twig->addFilter('outputImage', new \Twig_Filter_Function('Core\Brick\Twig\Helper::outputImage'));
        ...
        $this->_twig->addFilter('url', new \Twig_Filter_Function('Core\Brick\Twig\Helper::url'));
